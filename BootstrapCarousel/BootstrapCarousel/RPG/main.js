...
//mapArray: decide every elements in the map
//ctx : HTML5 Canvas
...
$(document).ready(function() {
    ...
    imgMountain.onload=function(){
        ...
        for(var x in mapArray)
        {
            ...
            {
              ctx.drawImage(imgEnemy,7,40,104,135,x%3*200,Math.floor(x/3)*200,200,200,200);
            }
        }
    };};
...
$(document).keydown(function(event){
    ...
    switch(mapArray[targetBlock])
            {
                case undefined://
                    $("#talkBox").text("limitation");
                break;
                case 1:
                    $("#talkBox").text("restriction");
                break;
                case 2://
                    $("#talkBox").text("arrive!");
                break;
